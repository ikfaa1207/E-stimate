                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('projects.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="lot_area" name="lot_area" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('lot_area')" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="building_type" name="building_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                                        <option value="residential" @selected(old('building_type') == 'residential')>Residential</option>
                                        <option value="commercial" @selected(old('building_type') == 'commercial')>Commercial</option>
                                        <option value="industrial" @selected(old('building_type') == 'industrial')>Industrial</option>
                                        <option value="institutional" @selected(old('building_type') == 'institutional')>Institutional (School, Hospital, etc.)</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="structural_type" name="structural_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                                        <option value="concrete" @selected(old('structural_type') == 'concrete')>Reinforced Concrete</option>
                                        <option value="steel" @selected(old('structural_type') == 'steel')>Structural Steel</option>
                                        <option value="mixed" @selected(old('structural_type') == 'mixed')>Mixed Concrete/Steel</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="foundation_type" name="foundation_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                                        <option value="footing" @selected(old('foundation_type') == 'footing')>Standard Isolated Footing</option>
                                        <option value="pile" @selected(old('foundation_type') == 'pile')>Pile Foundation (Deep Foundation)</option>
                                        <option value="raft" @selected(old('foundation_type') == 'raft')>Raft / Mat Foundation</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="number_of_floors" name="number_of_floors" type="number" min="1" class="mt-1 block w-full" :value="old('number_of_floors', 1)" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="gross_floor_area" name="gross_floor_area" type="number" step="0.01" min="0.01" class="mt-1 block w-full" :value="old('gross_floor_area')" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="footprint_area" name="footprint_area" type="number" step="0.01" min="0.01" class="mt-1 block w-full" :value="old('footprint_area')" required />
                                ...
                                <div>
                                    ...
                                    <select id="finish_level" name="finish_level" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                                        <option value="economy" @selected(old('finish_level') == 'economy')>Economy</option>
                                        <option value="standard" @selected(old('finish_level') == 'standard')>Standard</option>
                                        <option value="premium" @selected(old('finish_level') == 'premium')>Premium</option>
                                    </select>
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('notes') }}</textarea>
                            <x-input-error class="mt-2" :messages="$errors->get('notes')" />
                        </div>

                        <div class="flex justify-end gap-2">
                            <a href="{{ route('projects.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 rounded-md text-xs font-semibold uppercase">Cancel</a>
                            <x-primary-button>Create & Continue</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
